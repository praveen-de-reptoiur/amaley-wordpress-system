...
final class Amaley_Elementor_Page_Trust_Strip_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control( 'icon', array( 'label' => esc_html__( 'Icon', 'amaley-ui-sections-kit' ), 'type' => \Elementor\Controls_Manager::SELECT, 'default' => 'shield', 'options' => array( 'shield' => 'Shield / Trust', 'batch' => 'Batch / Product', 'leaf' => 'Leaf / Natural', 'mountain' => 'Mountain / Himalayan', 'cluster' => 'Cluster / Network', 'gift' => 'Gift', 'hands' => 'Hands / Care' ) ) );
		$repeater->add_control( 'title', array( 'label' => esc_html__( 'Title', 'amaley-ui-sections-kit' ), 'type' => \Elementor\Controls_Manager::TEXT, 'default' => esc_html__( 'Small batch', 'amaley-ui-sections-kit' ) ) );
		$repeater->add_control( 'text', array( 'label' => esc_html__( 'Short Text', 'amaley-ui-sections-kit' ), 'type' => \Elementor\Controls_Manager::TEXTAREA, 'rows' => 2, 'default' => esc_html__( 'Made with care, not pressure.', 'amaley-ui-sections-kit' ) ) );
		...
		$this->start_controls_section( 'layout_section', array( 'label' => esc_html__( 'Layout & Style', 'amaley-ui-sections-kit' ), 'tab' => \Elementor\Controls_Manager::TAB_CONTENT ) );
