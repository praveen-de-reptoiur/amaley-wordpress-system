...
/**
 * Renders a reusable page trust/promise strip for hero-below and page-intro sections.
 */
final class Amaley_UI_Trust_Strip {

	/**
	 * Renders the shortcode or Elementor widget output.
	 *
	...
	private static function normalize_atts( $atts ) {
		...
		// v0.3.4: support both developer-safe `motion` and human-facing `transformation` shortcode attributes.
		...
		$atts['motion'] = isset( $motion_aliases[ $motion_source ] ) ? $motion_aliases[ $motion_source ] : 'glow';
	...
	/**
	 * Normalizes item arrays from Elementor or shortcode pipe strings.
	 *
	...
	/**
	 * Returns scoped inline SVG for icon key.
	 *
	...
	private static function icon_svg( $icon ) {
		...
		$icons = array(
			...
			'gift'     => '<svg viewBox="0 0 24 24" focusable="false"><path d="M4.5 9.5h15v10h-15v-10Z"/><path d="M4 9.5V6.8h16v2.7"/><path d="M12 6.8v12.7"/><path d="M12 6.8C10.2 3.8 7 3.8 7.2 6c.2 1.7 2.4 1.2 4.8.8Z"/><path d="M12 6.8c1.8-3 5-3 4.8-.8-.2 1.7-2.4 1.2-4.8.8Z"/></svg>',
			'hands'    => '<svg viewBox="0 0 24 24" focusable="false"><path d="M7 13.5 4.8 16c-.7.8-.6 2 .2 2.7l.2.2c.8.6 2 .5 2.7-.2l2.5-2.7"/><path d="M17 13.5 19.2 16c.7.8.6 2-.2 2.7l-.2.2c-.8.6-2 .5-2.7-.2l-2.5-2.7"/><path d="M8.5 9.2 12 12.4l3.5-3.2"/><path d="M12 12.4V4.5"/></svg>',
		);
