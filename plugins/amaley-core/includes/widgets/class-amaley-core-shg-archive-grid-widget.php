...
class Amaley_Core_SHG_Archive_Grid_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'section_card_content', array( 'label' => esc_html__( '5. Card Content Controls', 'amaley-core' ) ) );
        ...
        $this->add_control( 'card_bg', array( 'label' => esc_html__( 'Card Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card' => 'background: {{VALUE}};' ) ) );
        $this->add_control( 'card_border_color', array( 'label' => esc_html__( 'Card Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card' => 'border-color: {{VALUE}};' ) ) );
        $this->add_responsive_control( 'card_radius', array( 'label' => esc_html__( 'Card Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 60 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card' => 'border-radius: {{SIZE}}{{UNIT}};' ) ) );
        $this->add_responsive_control( 'card_body_padding', array( 'label' => esc_html__( 'Card Body Padding', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em','%' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;' ) ) );
        $this->add_responsive_control( 'card_inner_gap', array( 'label' => esc_html__( 'Card Inner Gap', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 36 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-body' => 'gap: {{SIZE}}{{UNIT}};' ) ) );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'image_height', array( 'label' => esc_html__( 'Image / Placeholder Height', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 60, 'max' => 360 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-image' => 'height: {{SIZE}}{{UNIT}} !important; min-height: {{SIZE}}{{UNIT}} !important;', '{{WRAPPER}} .amaley-core-shg-archive-image img' => 'height: {{SIZE}}{{UNIT}} !important; min-height: {{SIZE}}{{UNIT}} !important;' ) ) );
        $this->add_control( 'image_opacity', array( 'label' => esc_html__( 'Image Opacity', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'range' => array( 'px' => array( 'min' => 0.2, 'max' => 1, 'step' => 0.01 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-image img' => 'opacity: {{SIZE}};' ) ) );
        $this->add_responsive_control( 'placeholder_size', array( 'label' => esc_html__( 'Placeholder Circle Size', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 32, 'max' => 120 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-image-mark' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};' ) ) );
        $this->add_control( 'placeholder_bg', array( 'label' => esc_html__( 'Placeholder Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-image' => 'background: {{VALUE}};' ) ) );
        $this->add_control( 'verified_badge_bg', array( 'label' => esc_html__( 'Verified Badge Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-badge, {{WRAPPER}} .amaley-core-shg-badge-inline' => 'background: {{VALUE}};' ) ) );
        $this->add_control( 'verified_badge_color', array( 'label' => esc_html__( 'Verified Badge Text Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-badge, {{WRAPPER}} .amaley-core-shg-badge-inline' => 'color: {{VALUE}};' ) ) );
        $this->end_controls_section();
        ...
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'card_label_typography', 'label' => esc_html__( 'Card Label Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-card-label' ) );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'card_title_typography', 'label' => esc_html__( 'Card Title Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-archive-body h3' ) );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'card_desc_typography', 'label' => esc_html__( 'Card Description Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-card-desc' ) );
        $this->add_control( 'card_label_color', array( 'label' => esc_html__( 'Card Label Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-card-label' => 'color: {{VALUE}};' ) ) );
        $this->add_control( 'card_title_color', array( 'label' => esc_html__( 'Card Title Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-body h3' => 'color: {{VALUE}};' ) ) );
        $this->add_control( 'card_desc_color', array( 'label' => esc_html__( 'Card Description Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-card-desc' => 'color: {{VALUE}};' ) ) );
        $this->add_control( 'description_line_clamp', array( 'label' => esc_html__( 'Description Line Clamp', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::NUMBER, 'min' => 1, 'max' => 6, 'default' => 2, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-card-desc' => '-webkit-line-clamp: {{VALUE}};' ) ) );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'details_gap', array( 'label' => esc_html__( 'Details Gap', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 28 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid' => 'gap: {{SIZE}}{{UNIT}};' ) ) );
        $this->add_responsive_control( 'details_box_padding', array( 'label' => esc_html__( 'Details Box Padding', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid div' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->add_control( 'details_box_bg', array( 'label' => esc_html__( 'Details Box Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid div' => 'background: {{VALUE}};' ) ) );
        $this->add_control( 'details_box_border', array( 'label' => esc_html__( 'Details Box Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid div' => 'border-color: {{VALUE}};' ) ) );
        $this->add_control( 'details_label_color', array( 'label' => esc_html__( 'Details Label Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid dt' => 'color: {{VALUE}};' ) ) );
        $this->add_control( 'details_value_color', array( 'label' => esc_html__( 'Details Value Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid dd' => 'color: {{VALUE}};' ) ) );
        $this->add_control( 'details_line_clamp', array( 'label' => esc_html__( 'Details Value Line Clamp', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::NUMBER, 'min' => 1, 'max' => 4, 'default' => 2, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid dd' => '-webkit-line-clamp: {{VALUE}};' ) ) );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'tag_gap', array( 'label' => esc_html__( 'Tag Gap', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 24 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-products' => 'gap: {{SIZE}}{{UNIT}};' ) ) );
        $this->add_responsive_control( 'tag_padding', array( 'label' => esc_html__( 'Tag Padding', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-products span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        ...
        $this->add_control( 'tag_border_color', array( 'label' => esc_html__( 'Tag Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-products span' => 'border-color: {{VALUE}};' ) ) );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'button_padding', array( 'label' => esc_html__( 'Button Padding', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->add_responsive_control( 'button_radius', array( 'label' => esc_html__( 'Button Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 80 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn' => 'border-radius: {{SIZE}}{{UNIT}} !important;' ) ) );
        $this->add_control( 'button_bg', array( 'label' => esc_html__( 'Button Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn' => 'background: {{VALUE}} !important;' ) ) );
        $this->add_control( 'button_color', array( 'label' => esc_html__( 'Button Text Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn' => 'color: {{VALUE}} !important;' ) ) );
        $this->add_control( 'button_hover_bg', array( 'label' => esc_html__( 'Button Hover Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn:hover' => 'background: {{VALUE}} !important;' ) ) );
        $this->add_control( 'button_hover_color', array( 'label' => esc_html__( 'Button Hover Text Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn:hover' => 'color: {{VALUE}} !important;' ) ) );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'mobile_card_min_height', array( 'label' => esc_html__( 'Card Min Height', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 720 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card' => 'min-height: {{SIZE}}{{UNIT}};' ) ) );
