...
class Amaley_Core_SHG_Archive_Grid_Widget extends \Elementor\Widget_Base {
    /**
     * v1.0.107-full-controls
     * Live-site safe controls polish for SHG Archive Grid.
     * Scope: Elementor controls/selectors only. No data/query/render logic changes.
     */
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'style_section_background', array( 'label' => esc_html__( '7. Section Background / Box', 'amaley-core' ), 'tab' => \Elementor\Controls_Manager::TAB_STYLE ) );
        ...
        $this->add_responsive_control( 'section_margin', array( 'label' => esc_html__( 'Section Margin', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px', 'em', '%' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-grid-section' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->add_control( 'section_border_color', array( 'label' => esc_html__( 'Section Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-grid-section' => 'border-color: {{VALUE}};' ) ) );
        $this->add_responsive_control( 'section_border_width', array( 'label' => esc_html__( 'Section Border Width', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-grid-section' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; border-style: solid;' ) ) );
        $this->add_responsive_control( 'section_radius', array( 'label' => esc_html__( 'Section Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 80 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-grid-section' => 'border-radius: {{SIZE}}{{UNIT}};' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Box_Shadow::get_type(), array( 'name' => 'section_shadow', 'label' => esc_html__( 'Section Shadow', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-grid-section' ) );
        $this->end_controls_section();
        ...
        $this->add_responsive_control( 'card_padding', array( 'label' => esc_html__( 'Whole Card Padding', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em','%' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;' ) ) );
        ...
        $this->add_responsive_control( 'card_border_width', array( 'label' => esc_html__( 'Card Border Width', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important; border-style: solid !important;' ) ) );
        ...
        $this->start_controls_tabs( 'card_box_state_tabs' );
        $this->start_controls_tab( 'card_box_normal_tab', array( 'label' => esc_html__( 'Normal', 'amaley-core' ) ) );
        ...
        $this->add_group_control( \Elementor\Group_Control_Box_Shadow::get_type(), array( 'name' => 'card_shadow', 'label' => esc_html__( 'Card Shadow', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-archive-card, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive' ) );
        $this->end_controls_tab();

        $this->start_controls_tab( 'card_box_hover_tab', array( 'label' => esc_html__( 'Hover', 'amaley-core' ) ) );
        $this->add_control( 'card_hover_bg', array( 'label' => esc_html__( 'Card Hover Background', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card:hover, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive:hover' => 'background: {{VALUE}} !important;' ) ) );
        $this->add_control( 'card_hover_border_color', array( 'label' => esc_html__( 'Card Hover Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-card:hover, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive:hover' => 'border-color: {{VALUE}} !important;' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Box_Shadow::get_type(), array( 'name' => 'card_hover_shadow', 'label' => esc_html__( 'Card Hover Shadow', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-archive-card:hover, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive:hover' ) );
        $this->end_controls_tab();
        ...
        $this->add_control( 'image_position', array( 'label' => esc_html__( 'Image Position', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SELECT, 'default' => '', 'options' => array( '' => esc_html__( 'Default', 'amaley-core' ), 'center center' => esc_html__( 'Center Center', 'amaley-core' ), 'center top' => esc_html__( 'Center Top', 'amaley-core' ), 'center bottom' => esc_html__( 'Center Bottom', 'amaley-core' ), 'left center' => esc_html__( 'Left Center', 'amaley-core' ), 'right center' => esc_html__( 'Right Center', 'amaley-core' ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-image img, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__media img' => 'object-position: {{VALUE}} !important;' ) ) );
        $this->add_responsive_control( 'image_radius', array( 'label' => esc_html__( 'Image Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 50 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-image, {{WRAPPER}} .amaley-core-shg-archive-image img, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__media, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__media img' => 'border-radius: {{SIZE}}{{UNIT}} !important;' ) ) );
        ...
        /** 12. Text style */
        $this->start_controls_section( 'style_card_text', array( 'label' => esc_html__( '12. Card Text / Typography', 'amaley-core' ), 'tab' => \Elementor\Controls_Manager::TAB_STYLE ) );
        ...
        $this->add_responsive_control( 'card_label_margin', array( 'label' => esc_html__( 'Card Label Margin', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-card-label, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;' ) ) );
        ...
        $this->add_responsive_control( 'card_title_margin', array( 'label' => esc_html__( 'Card Title Margin', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-body h3, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;' ) ) );
        ...
        $this->add_responsive_control( 'card_desc_margin', array( 'label' => esc_html__( 'Card Description Margin', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px','em' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-card-desc, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;' ) ) );
        ...
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'details_label_typography', 'label' => esc_html__( 'Details Label Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-detail-grid dt, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__meta span' ) );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'details_value_typography', 'label' => esc_html__( 'Details Value Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-detail-grid dd, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__meta strong' ) );
        $this->add_responsive_control( 'details_box_radius', array( 'label' => esc_html__( 'Details Box Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 40 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-detail-grid div, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__meta-item' => 'border-radius: {{SIZE}}{{UNIT}} !important;' ) ) );
        ...
        $this->add_responsive_control( 'tag_radius', array( 'label' => esc_html__( 'Tag Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px' ), 'range' => array( 'px' => array( 'min' => 0, 'max' => 40 ) ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-products span, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__tags span' => 'border-radius: {{SIZE}}{{UNIT}} !important;' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'tag_typography', 'label' => esc_html__( 'Tag Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-products span, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__tags span' ) );
        ...
        $this->add_responsive_control( 'button_border_width', array( 'label' => esc_html__( 'Button Border Width', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px' ), 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__button' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important; border-style: solid !important;' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'button_typography', 'label' => esc_html__( 'Button Typography', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-archive-btn, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__button' ) );

        $this->start_controls_tabs( 'button_style_tabs' );
        $this->start_controls_tab( 'button_normal_tab', array( 'label' => esc_html__( 'Normal', 'amaley-core' ) ) );
        ...
        $this->add_control( 'button_border_color', array( 'label' => esc_html__( 'Button Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__button' => 'border-color: {{VALUE}} !important;' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Box_Shadow::get_type(), array( 'name' => 'button_shadow', 'label' => esc_html__( 'Button Shadow', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-archive-btn, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__button' ) );
        $this->end_controls_tab();

        $this->start_controls_tab( 'button_hover_tab', array( 'label' => esc_html__( 'Hover', 'amaley-core' ) ) );
        ...
        $this->add_control( 'button_hover_border_color', array( 'label' => esc_html__( 'Button Hover Border Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .amaley-core-shg-archive-btn:hover, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__button:hover' => 'border-color: {{VALUE}} !important;' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Box_Shadow::get_type(), array( 'name' => 'button_hover_shadow', 'label' => esc_html__( 'Button Hover Shadow', 'amaley-core' ), 'selector' => '{{WRAPPER}} .amaley-core-shg-archive-btn:hover, {{WRAPPER}} .amaley-core-shg-grid-section-og .amaley-card--shg-archive .amaley-card__button:hover' ) );
        $this->end_controls_tab();
        $this->end_controls_tabs();
        $this->end_controls_section();
