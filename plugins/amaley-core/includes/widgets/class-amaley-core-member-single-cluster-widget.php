<?php
/** Amaley Member Single Linked Cluster Elementor widget — full-control safe version. */
...
class Amaley_Core_Member_Single_Cluster_Widget extends \Elementor\Widget_Base {
    ...
    public function get_keywords() { return array( 'amaley', 'member', 'producer', 'single', 'cluster' ); }
    ...
    protected function register_controls() {
        ...
        $this->register_common_style_controls( '.amms-related-cluster' );
        $this->register_specific_style_controls( '.amms-related-cluster' );
        $this->register_og_card_fine_controls( '.amms-related-cluster' );
    }
