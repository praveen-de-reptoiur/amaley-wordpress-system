<?php
/** Amaley Member Single Contact CTA Elementor widget — full-control safe version. */
if ( ! defined( 'ABSPATH' ) ) { exit; }
if ( ! class_exists( '\\Elementor\\Widget_Base' ) ) { return; }

class Amaley_Core_Member_Single_Contact_Widget extends \Elementor\Widget_Base {
    public function get_name() { return 'amaley_core_member_single_contact'; }
    public function get_title() { return esc_html__( 'Amaley Member Single Contact CTA', 'amaley-core' ); }
    ...
    public function get_keywords() { return array( 'amaley', 'member', 'producer', 'single', 'contact cta' ); }
    ...
    protected function register_controls() {
        ...
        $this->register_common_style_controls( '.amms-contact' );
        $this->register_specific_style_controls( '.amms-contact' );
    }
    ...
    private function register_specific_style_controls( $section_selector ) {
        $s = '{{WRAPPER}} ' . $section_selector;
        $this->start_controls_section( 'style_contact_card', array( 'label' => esc_html__( 'CTA: Card / Phone / Buttons', 'amaley-core' ), 'tab' => \Elementor\Controls_Manager::TAB_STYLE ) );
        $this->add_responsive_control( 'contact_card_width', array( 'label' => esc_html__( 'CTA Card Width', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::SLIDER, 'size_units' => array( 'px', '%' ), 'range' => array( 'px' => array( 'min' => 320, 'max' => 1400 ), '%' => array( 'min' => 40, 'max' => 100 ) ), 'selectors' => array( $s . ' .amms-contact-card' => 'width: min({{SIZE}}{{UNIT}}, 100%);' ) ) );
        $this->add_group_control( \Elementor\Group_Control_Background::get_type(), array( 'name' => 'contact_card_background', 'selector' => $s . ' .amms-contact-card' ) );
        $this->add_group_control( \Elementor\Group_Control_Border::get_type(), array( 'name' => 'contact_card_border', 'selector' => $s . ' .amms-contact-card' ) );
        $this->add_group_control( \Elementor\Group_Control_Box_Shadow::get_type(), array( 'name' => 'contact_card_shadow', 'selector' => $s . ' .amms-contact-card' ) );
        $this->add_responsive_control( 'contact_card_padding', array( 'label' => esc_html__( 'CTA Card Padding', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px', 'em' ), 'selectors' => array( $s . ' .amms-contact-card' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->add_responsive_control( 'contact_card_margin', array( 'label' => esc_html__( 'CTA Card Margin', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px', 'em' ), 'selectors' => array( $s . ' .amms-contact-card' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->add_responsive_control( 'contact_card_radius', array( 'label' => esc_html__( 'CTA Card Radius', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px', '%' ), 'selectors' => array( $s . ' .amms-contact-card' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->add_control( 'phone_heading', array( 'label' => esc_html__( 'Phone / WhatsApp Line', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::HEADING, 'separator' => 'before' ) );
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array( 'name' => 'phone_typography', 'selector' => $s . ' .amms-phone' ) );
        $this->add_control( 'phone_color', array( 'label' => esc_html__( 'Phone Text Color', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => array( $s . ' .amms-phone' => 'color: {{VALUE}};' ) ) );
        $this->add_responsive_control( 'phone_margin', array( 'label' => esc_html__( 'Phone Line Margin', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::DIMENSIONS, 'size_units' => array( 'px', 'em' ), 'selectors' => array( $s . ' .amms-phone' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ) ) );
        $this->end_controls_section();
    }
