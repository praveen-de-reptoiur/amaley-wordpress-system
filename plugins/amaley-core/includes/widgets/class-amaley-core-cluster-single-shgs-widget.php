...
class Amaley_Core_Cluster_Single_SHGs_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'section_button_text', array( 'label' => esc_html__( 'Section Button Text', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'View all SHG groups' ) );
        $this->add_control( 'section_button_url', array( 'label' => esc_html__( 'Section Button URL', 'amaley-core' ), 'type' => \Elementor\Controls_Manager::TEXT, 'default' => '/shg-groups/' ) );
