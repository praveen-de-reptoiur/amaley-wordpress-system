...
class Amaley_Core_Fields {
    /**
     * Return registry by entity.
     *
     * @param string $entity cluster|shg|member.
     * @return array
     */
     ...
     * @return array
     */
    public function verification_options() {
        return array(
            'verified' => 'Verified',
            'pending'  => 'Pending',
            'review'   => 'Needs Review',
    ...
    /**
     * CSV template columns by import/export type.
     *
     * @param string $type Import/export type.
     * @return array
     */
