...
abstract class Amaley_CW_Base_Widget extends \Elementor\Widget_Base {
	...
	protected function layout_controls() {
		...
		$this->add_control( 'alignment_note', array( 'label' => esc_html__( 'Fine Alignment Controls', 'amaley-compact-widgets' ), 'type' => \Elementor\Controls_Manager::HEADING, 'separator' => 'before' ) );
		$this->add_responsive_control( 'header_align', array( 'label' => esc_html__( 'Header Alignment', 'amaley-compact-widgets' ), 'type' => \Elementor\Controls_Manager::CHOOSE, 'default' => $defaults['align'], 'options' => array( 'left' => array( 'title' => 'Left', 'icon' => 'eicon-text-align-left' ), 'center' => array( 'title' => 'Center', 'icon' => 'eicon-text-align-center' ), 'right' => array( 'title' => 'Right', 'icon' => 'eicon-text-align-right' ) ), 'selectors' => array( '{{WRAPPER}} .amaley-cw4-head' => 'text-align: {{VALUE}};' ) ) );
		$this->add_responsive_control( 'card_align', array( 'label' => esc_html__( 'Card / Item Text Alignment', 'amaley-compact-widgets' ), 'type' => \Elementor\Controls_Manager::CHOOSE, 'default' => 'left', 'options' => array( 'left' => array( 'title' => 'Left', 'icon' => 'eicon-text-align-left' ), 'center' => array( 'title' => 'Center', 'icon' => 'eicon-text-align-center' ), 'right' => array( 'title' => 'Right', 'icon' => 'eicon-text-align-right' ) ), 'selectors' => array( '{{WRAPPER}} .amaley-cw4-card, {{WRAPPER}} .amaley-cw4-icon-card, {{WRAPPER}} .amaley-cw4-process-card, {{WRAPPER}} .amaley-cw4-image-card, {{WRAPPER}} .amaley-cw4-info-image-card, {{WRAPPER}} .amaley-cw4-panels article, {{WRAPPER}} .amaley-cw4-quote, {{WRAPPER}} .amaley-cw4-cta, {{WRAPPER}} .amaley-cw4-metric, {{WRAPPER}} .amaley-cw4-route article, {{WRAPPER}} .amaley-cw4-story-lines article, {{WRAPPER}} .amaley-cw4-gift-panel article, {{WRAPPER}} .amaley-cw4-values-row article, {{WRAPPER}} .amaley-cw4-purpose-grid article' => 'text-align: {{VALUE}};' ) ) );
		$this->add_responsive_control( 'button_align', array( 'label' => esc_html__( 'Button Row Alignment', 'amaley-compact-widgets' ), 'type' => \Elementor\Controls_Manager::CHOOSE, 'default' => 'flex-start', 'options' => array( 'flex-start' => array( 'title' => 'Left', 'icon' => 'eicon-align-start-h' ), 'center' => array( 'title' => 'Center', 'icon' => 'eicon-align-center-h' ), 'flex-end' => array( 'title' => 'Right', 'icon' => 'eicon-align-end-h' ) ), 'selectors' => array( '{{WRAPPER}} .amaley-cw4-actions' => 'justify-content: {{VALUE}};' ) ) );
