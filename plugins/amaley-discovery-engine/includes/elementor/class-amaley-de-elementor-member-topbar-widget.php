...
class Amaley_DE_Elementor_Member_Topbar_Widget extends Amaley_DE_Elementor_Member_Widget {
    public function get_name() { return 'amaley_member_topbar_discovery'; }
