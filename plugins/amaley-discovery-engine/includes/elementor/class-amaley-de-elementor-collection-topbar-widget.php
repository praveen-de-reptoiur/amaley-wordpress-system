...
class Amaley_DE_Elementor_Collection_Topbar_Widget extends Amaley_DE_Elementor_Collection_Widget {
    public function get_name() { return 'amaley_collection_topbar_discovery'; }
